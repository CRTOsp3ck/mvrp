...
var GoodsReturnNoteViewWhere = struct {
	...
	IssueDate:                    whereHelpernull_Time{field: "\"sale\".\"goods_return_note_view\".\"issue_date\""},
	ReturnDate:                   whereHelpernull_Time{field: "\"sale\".\"goods_return_note_view\".\"return_date\""},
	CustomerID:                   whereHelpernull_Int{field: "\"sale\".\"goods_return_note_view\".\"customer_id\""},
	ReceivingLocationInformation: whereHelpernull_String{field: "\"sale\".\"goods_return_note_view\".\"receiving_location_information\""},
	ReceivedBy:                   whereHelpernull_String{field: "\"sale\".\"goods_return_note_view\".\"received_by\""},
	OverallGoodsCondition:        whereHelpernull_String{field: "\"sale\".\"goods_return_note_view\".\"overall_goods_condition\""},
	ReturnReason:                 whereHelpernull_String{field: "\"sale\".\"goods_return_note_view\".\"return_reason\""},
...
var (
	goodsReturnNoteViewAllColumns            = []string{"id", "base_document_id", "goods_return_note_number", "sales_order_id", "invoice_id", "credit_note_id", "rma_id", "issue_date", "return_date", "customer_id", "receiving_location_information", "received_by", "overall_goods_condition", "return_reason", "base_document", "goods_return_note_items"}
	goodsReturnNoteViewColumnsWithoutDefault = []string{}
	goodsReturnNoteViewColumnsWithDefault    = []string{"id", "base_document_id", "goods_return_note_number", "sales_order_id", "invoice_id", "credit_note_id", "rma_id", "issue_date", "return_date", "customer_id", "receiving_location_information", "received_by", "overall_goods_condition", "return_reason", "base_document", "goods_return_note_items"}
